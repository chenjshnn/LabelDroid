...
- Slide: [ICSE-jieshan.pptx](ICSE-jieshan.pptx)
...
<img src="./assets/Introduction/Figure1.png" alt="Example of UI components and labels"  width="500"/>

(2) Figure 2 shows how to set up an image-based button within the source code

<img src="./assets/Introduction/Figure2.png" alt="Source code for setting up labels for 'add playlist' button (which is indeed a clickable ImageView)"   width="600"/>
...
<img src="./assets/Introduction/Figure3.png" alt="Examples of image-based buttons 1:clickable ImageView; 2/3:ImageButton"   width="350"/>
...
<img src="./assets/Motivational_mining_study/Table1.png" alt="Statistics of label missing situation"  width="600" />
...
<img src="./assets/Motivational_mining_study/Figure4.png" alt="The distribution of the category of applications with different rate of image-based buttons missing content description"   width="600"/>
...
<img src="./assets/Motivational_mining_study/Figure5.png" alt="Box-plot for missing rate distribution of all apps with different download number"   width="350"/>
...
<img src="./assets/Approach/Figure6.png" alt="Overview of our approach" />
...
*The full list of meaningless labels can be seen at [meaningless_label](./meaningless_label.txt)*


## DATASET
Figure 7 shows some examples in our dataset.

<img src="./assets/Dataset/Figure7.png" alt="Examples of our dataset" width="350"/>
...
<img src="./assets/Dataset/Table2.png" alt="Dataset Statistics" width="350"/>
...
![Accuracy Results ](assets/Accuracy/Table3.png)
...
![Accuracy Results](assets/Accuracy/Figure8.png)

Qualitative Performance with Baselines
![Accuracy Results](assets/Accuracy/Table4.png)

Common causes for generation failure
![Accuracy Results](assets/Accuracy/Table5.png)
...
<img src="assets/Generalization&Usefulness/app_details.png" alt="The acceptability score (AS) and the standard deviation for 12 completely unseen apps. * denotes p < 0.05."/>

<img src="assets/Generalization&Usefulness/boxplot.png" alt="Distribution of app acceptability scores by human
...
<img src="assets/Generalization&Usefulness/Table7.png" alt="Examples of generalization" />
